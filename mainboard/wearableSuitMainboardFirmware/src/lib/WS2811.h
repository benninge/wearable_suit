...
#define WS2811_PWM_PERIOD	125//19 //timer period time, don't know why but it works with 168 MHz Systemclock
#define WS2811_PWM_ZERO     (WS2811_PWM_PERIOD / 3 + 1)  // 0.5 µs of 2.5µs is high => 1/5 of the period
#define WS2811_PWM_ONE      (WS2811_PWM_PERIOD - WS2811_PWM_ZERO) // 2µs of 2.5µs is high -> 4/5 of the period


// number of timer cycles (~2.5µs) for the reset pulse
#define WS2811_RESET_LEN     500//20 //20*2.5µs = 50µs
...
#define WS2811_BIT_TRANSFER_DURATION 1250//2500 //in nS per Bit
